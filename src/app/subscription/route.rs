...
pub async fn subscribe(
    ...
    if let Err(_) = store_token(&state.db, subscriber_id, &subscription_token).await {
...
async fn insert_subscriber(db: &PgPool, subscriber: &NewSubscriber) -> Result<Uuid, sqlx::Error> {
